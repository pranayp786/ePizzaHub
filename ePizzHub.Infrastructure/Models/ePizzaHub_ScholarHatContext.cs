...
namespace ePizzHub.Infrastructure.Models;

public partial class ePizzaHub_ScholarHatContext : DbContext
{
    public ePizzaHub_ScholarHatContext(DbContextOptions<ePizzaHub_ScholarHatContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserToke__3214EC07C38A46F7");
